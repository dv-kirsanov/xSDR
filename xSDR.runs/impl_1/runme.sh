...
HD_PWD='C:/Xilinx/Projects/xSDR/xSDR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xsdr_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xsdr_design_1_wrapper.tcl -notrace
