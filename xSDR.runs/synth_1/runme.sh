...
HD_PWD='C:/Xilinx/Projects/xSDR/xSDR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xsdr_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xsdr_design_1_wrapper.tcl
